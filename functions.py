...
def getconfigs(file):
    ...
    return apitoken,url,backup,port,blockinterval,minmissedblocks,channelnames,usernames,numdelegates,blockrewards,blockspermin
...
def printforgingpools(pools):
    ...
    pool=pools.sort_values(by='rank')
